...
// 		});
        ...
        $(".planModalsDiv").on("click", ".placeCard", function() {
            console.log("여행지 클릭");
         	...
         	let goPlace = $(this);
         	let placeImg = $(this).find(".img-thumbnail img").attr("src");
		...
		$(".tripPlanDiv").on('click', '.deleteBtn', function() {
		    ...
		    $(this).closest(".planListDiv").siblings(".planModalsDiv")
		    	.load("/planAjax/getPlanWriteForm.do", function() {
		            ...
		            $("#planWriteModal").find(".modal-footer .modalMultiBtn").addClass("btn-danger").text("remove");
			...
			<form method="post" action="update.do">
				...
				<div class="modal-body">
					...
					<div class="form-group tripPeriodForm">
						...
						<input type="hidden" name="tripStartDate" class="tripStartDateInput" value="${vo.tripStartDate }">
						<input type="hidden" name="tripEndDate" class="tripEndDateInput" value="${vo.tripEndDate }">
